                                        ...
                                        <td>
                                            <div class="round-img">
                                                <a href=""><img class="w-35"
                                                        src="{!!asset('dashboard/assets/images/avatar/1.jpg')!!}"
                                                        alt=""></a>
                                            </div>
                                        </td>
                                        <td>Lew Shawon</td>
                        ...
                        <div class="tdl-holder">
                            <div class="tdl-content">
                                <ul>
                                    <li>
                                        <label>
                                            <input type="checkbox"><i></i><span>Post three to six times on
                                                Twitter.</span>
                ...
                <div class="card">
                    ...
                    <div class="recent-comment">
                        <div class="media">
                            <div class="media-left">
                                <a href="#"><img class="media-object"
                                        src="{!!asset('dashboard/assets/images/avatar/1.jpg')!!}" alt="..."></a>
                            </div>
                        ...
                        <div class="media">
                            <div class="media-left">
                                <a href="#"><img class="media-object"
                                        src="{!!asset('dashboard/assets/images/avatar/2.jpg')!!}" alt="..."></a>
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media no-border">
                            <div class="media-left">
                                <a href="#"><img class="media-object"
                                        src="{!!asset('dashboard/assets/images/avatar/3.jpg')!!}" alt="..."></a>
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading">Mr. John</h4>
                                <p>Cras sit amet nibh libero, in gravida nulla. </p>
